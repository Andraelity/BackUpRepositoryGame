...
public class WordHandler_PairSentences : MonoBehaviour
{
    ...
    {	
		...
		if(widthText_One > 53.0f)
		{
			...
			float heightText_One_Operative = (float)System.Math.Round((heightText_One ) -4.65, 2);

			// Debug.Log(heightText_One_Operative/2.5 == 1);

			if(heightText_One_Operative/2.5 == 1 )
			{
			...
			if(heightText_One_Operative/2.5 == 2 )
			{
    ...
    {	
		...
		TextAsset asset = (TextAsset)Resources.Load("SentencesFolder/SentencesListEnglish");
		...
		asset = (TextAsset)Resources.Load("SentencesFolder/SentencesListFrench");
